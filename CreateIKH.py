...
def IKHandles():
    ...
    base.ikHandle(name="IK_L_Ball", sj=base.ls("RIG_L_Foot")[0], ee=base.ls("RIG_L_Ball")[0], sol='ikSCsolver')
    base.ikHandle(name="IK_R_Ball", sj=base.ls("RIG_R_Foot")[0], ee=base.ls("RIG_R_Ball")[0], sol='ikSCsolver')

    base.ikHandle(name="IK_L_Toes", sj=base.ls("RIG_L_Ball")[0], ee=base.ls("RIG_L_Toes")[0], sol='ikSCsolver')
